...
function load_data()
{
   ...
   type:"POST",
    ...
    success: function(data){
        ...
        '<button class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-expanded="false" type="button" style="margin-left:2px;width:150px;margin-top:13px;">Theaters</button>'+
            '<div class="dropdown-menu" role="menu">'+
                '<a class="dropdown-item" role="presentation" href="#">First Item</a>'+
                '<a class="dropdown-item" role="presentation" href="#">Second Item</a>'+
                '<a class="dropdown-item" role="presentation" href="#">Third Item</a></div>'+
       ' </div>'+
        '<button class="btn btn-primary btn-block" style="background-color:rgb(0,123,255);width:95px;margin-top:-42px;margin-left:178px;padding:6px;">Seat Map</button>'+
